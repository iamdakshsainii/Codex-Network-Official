import React, { useState, useEffect, useRef } from 'react';
    ...
    function Navbar() {
      ...
      return (
        <nav className={`bg-black/50 backdrop-blur-md border-b border-blue-500/20 fixed top-0 left-0 w-full z-50 transition-all duration-300`}>
                 ...
                 <div ref={discoverRef} className="relative">
                  ...
                  {isDiscoverOpen && (
                    <div className="absolute right-0 top-full mt-2 bg-gray-800/50 backdrop-blur-sm rounded-md p-2 border border-blue-500/20 w-48">
                      ...
                      <Link to="/notes" className="block px-4 py-2 text-gray-300 hover:text-blue-400 whitespace-nowrap">My Notes</Link>
                    </div>
                  )}
                </div>
              ...
              <div className="md:hidden pb-4">
                <div className="flex flex-col space-y-4">
                  ...
                  <MobileNavLink to="/careers/all" onClick={() => setIsOpen(false)} active={location.pathname === '/careers/all'}>All Career Paths</MobileNavLink>
                   ...
                   <MobileNavLink to="/notes" onClick={() => setIsOpen(false)} >My Notes</MobileNavLink>
                </div>
              </div>
            )}
          </div>
