      ...
      return (
        <section id="about-us" className={`container mx-auto px-4 py-16 mb-16 ${className} transition-opacity duration-500`}>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-blue-500/20 hover:shadow-[0_0_12px_5px_rgba(0,0,255,0.4)] hover:scale-102 transition-all duration-300 glow-card max-w-xl">
