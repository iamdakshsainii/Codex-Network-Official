      ...
      const steps = [
        {
          ...
          `,
          demo: '<div style="padding: 20px; border: 1px solid #ccc; text-align: center;"><div id="demo-weather-container"><input type="text" placeholder="Enter City" /><button>Search</button><div id="demo-weatherInfo"></div></div></div>',
        },
        {
          ...
          `,
          demo: '<div style="padding: 20px; border: 1px solid #ccc; text-align: center;"><div id="demo-weather-container" style="text-align: center;"><input type="text" placeholder="Enter City" style="padding: 10px; margin-right: 10px;" /><button style="padding: 10px;">Search</button><div id="demo-weatherInfo" style="margin-top: 20px;"></div></div></div>',
        },
        {
          ...
          `,
          demo: '<div style="padding: 20px; border: 1px solid #ccc; text-align: center;"><div id="demo-weather-container"><input type="text" placeholder="Enter City" style="padding: 10px; margin-right: 10px;" /><button style="padding: 10px;">Search</button><div id="demo-weatherInfo" style="margin-top: 20px;"></div></div></div>',
        },
        {
