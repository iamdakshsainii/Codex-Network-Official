      ...
      const steps = [
        {
          ...
          description: 'Create the basic HTML for the expense tracker.',
          code: `
          ...
          `,
          demo: '<div style="padding: 20px; border: 1px solid #ccc; text-align: center;"><div id="demo-tracker-container"><input type="text" placeholder="Enter item" /><input type="number" placeholder="Enter amount" /><button>Add Expense</button><div id="demo-expenseList"></div></div></div>',
        },
        {
          ...
          `,
          demo: '<div style="padding: 20px; border: 1px solid #ccc; text-align: center;"><div id="demo-tracker-container" style="text-align: center;"><input type="text" placeholder="Enter item" style="padding: 10px; margin-right: 10px;" /><input type="number" placeholder="Enter amount" style="padding: 10px; margin-right: 10px;" /><button style="padding: 10px;">Add Expense</button><div id="demo-expenseList" style="margin-top: 20px;"></div></div></div>',
        },
        {
          ...
          `,
          demo: '<div style="padding: 20px; border: 1px solid #ccc; text-align: center;"><div id="demo-tracker-container"><input type="text" placeholder="Enter item" style="padding: 10px; margin-right: 10px;" /><input type="number" placeholder="Enter amount" style="padding: 10px; margin-right: 10px;" /><button style="padding: 10px;">Add Expense</button><div id="demo-expenseList" style="margin-top: 20px;"></div></div></div>',
        },
        {
