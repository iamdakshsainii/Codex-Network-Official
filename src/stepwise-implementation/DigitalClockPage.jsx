      ...
      const steps = [
        {
          ...
          demo: '<div style="padding: 20px; border: 1px solid #ccc; text-align: center;"><div id="demo-clock" style="font-size: 2em; padding: 10px; border: 2px solid #4f46e5; border-radius: 8px;"></div><script>function demoUpdateClock() { const now = new Date(); const time = now.toLocaleTimeString(); document.getElementById("demo-clock").textContent = time; setInterval(demoUpdateClock, 1000); } demoUpdateClock();</script></div>',
        },
        {
        ...
        },
        {
          ...
          code: `// JavaScript code for digital clock functionality
